...
const SKINS := [
    ...
    {"id": "phoenix", "name": "Phoenix", "cost": 10000, "shape": "phoenix", "idle": "flap", "trail_style": "flame", "player": Color(1.0, 0.58, 0.0, 1.0), "accent": Color(1.0, 0.08, 0.0, 1.0), "trail": Color(1.0, 0.36, 0.0, 0.76), "flash": Color(1.0, 0.84, 0.18, 1.0), "land": Color(1.0, 0.45, 0.08, 1.0), "death": Color(1.0, 0.22, 0.0, 1.0), "trail_width": 19.0, "flip_amount": 68, "land_amount": 36, "death_amount": 160},
]
